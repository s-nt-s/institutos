// Fuente https://gitlab.com/IvanSanchez/cuantotardamiautobus/-/raw/master/src/madrid/lib/leaflet-tilelayer-wmts-src.js
...
//         tilematrixSet: '',
    ...
    initialize: function (url, options) { // (String, Object)
        ...
        for (var i in options) {
            ...
            if (!(i in this.options) && !this.options.hasOwnProperty(i) && i!="matrixIds") {
